(function($) {
    ...
    var analyzer = new Analyzer([ie, chrome]);
    analyzer.collectDocumentTags('body');
    ...
    for (var id = 0; id < browsersInfo.length; id++) {
        console.log(browsersInfo[id]._name + ' ' + browsersInfo[id]._version);
    }
